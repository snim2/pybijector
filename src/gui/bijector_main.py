...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.debugToolBar = QtGui.QToolBar(MainWindow)
        self.debugToolBar.setObjectName(_fromUtf8("debugToolBar"))
        MainWindow.addToolBar(QtCore.Qt.TopToolBarArea, self.debugToolBar)
        MainWindow.insertToolBarBreak(self.debugToolBar)
        ...
        self.action_Set_Breakpoint_Debug = QtGui.QAction(MainWindow)
        self.action_Set_Breakpoint_Debug.setObjectName(_fromUtf8("action_Set_Breakpoint_Debug"))
        self.action_Debugger_Toolbar_View = QtGui.QAction(MainWindow)
        self.action_Debugger_Toolbar_View.setCheckable(True)
        self.action_Debugger_Toolbar_View.setObjectName(_fromUtf8("action_Debugger_Toolbar_View"))
        self.action_Print_Stacktrace_Debug = QtGui.QAction(MainWindow)
        self.action_Print_Stacktrace_Debug.setObjectName(_fromUtf8("action_Print_Stacktrace_Debug"))
        self.action_Step_Debug = QtGui.QAction(MainWindow)
        self.action_Step_Debug.setObjectName(_fromUtf8("action_Step_Debug"))
        self.action_Next_Debug = QtGui.QAction(MainWindow)
        self.action_Next_Debug.setObjectName(_fromUtf8("action_Next_Debug"))
        self.action_Until_Debug = QtGui.QAction(MainWindow)
        self.action_Until_Debug.setObjectName(_fromUtf8("action_Until_Debug"))
        self.action_Return_Debug = QtGui.QAction(MainWindow)
        self.action_Return_Debug.setObjectName(_fromUtf8("action_Return_Debug"))
        self.action_Continue_Debug = QtGui.QAction(MainWindow)
        self.action_Continue_Debug.setObjectName(_fromUtf8("action_Continue_Debug"))
        self.action_Jump_Debug = QtGui.QAction(MainWindow)
        self.action_Jump_Debug.setObjectName(_fromUtf8("action_Jump_Debug"))
        self.action_Args_To_Current_Function_Debug = QtGui.QAction(MainWindow)
        ...
        self.menuWindow.addAction(self.action_Debugger_Toolbar_View)
        ...
        self.menuDebug.addAction(self.action_Debug_Threaded_Code_Run)
        self.menuDebug.addAction(self.action_Debug_CSP_Code_Run)
        self.menuDebug.addSeparator()
        self.menuDebug.addAction(self.action_Clear_All_Breakpoints_Run)
        self.menuDebug.addSeparator()
        self.menuDebug.addAction(self.action_Print_Stacktrace_Debug)
        self.menuDebug.addSeparator()
        self.menuDebug.addAction(self.action_Step_Debug)
        self.menuDebug.addAction(self.action_Next_Debug)
        self.menuDebug.addAction(self.action_Until_Debug)
        self.menuDebug.addAction(self.action_Return_Debug)
        self.menuDebug.addAction(self.action_Continue_Debug)
        self.menuDebug.addAction(self.action_Jump_Debug)
        self.menuDebug.addSeparator()
        self.menuDebug.addAction(self.action_Args_To_Current_Function_Debug)
        self.menuDebug.addAction(self.action_Evaluate_Expression_in_Current_Context)
        ...
        self.debugToolBar.addAction(self.action_Step_Debug)
        self.debugToolBar.addAction(self.action_Next_Debug)
        self.debugToolBar.addAction(self.action_Until_Debug)
        self.debugToolBar.addAction(self.action_Return_Debug)
        self.debugToolBar.addAction(self.action_Continue_Debug)
        self.debugToolBar.addSeparator()
        self.debugToolBar.addAction(self.action_Jump_Debug)
        self.debugToolBar.addSeparator()
        ...
        QtCore.QObject.connect(self.action_Continue_Debug, QtCore.SIGNAL(_fromUtf8("triggered()")), MainWindow.debug_continue)
        QtCore.QObject.connect(self.action_Jump_Debug, QtCore.SIGNAL(_fromUtf8("triggered()")), MainWindow.debug_jump)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.debugToolBar.setWindowTitle(QtGui.QApplication.translate("MainWindow", "toolBar_2", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.action_Set_Breakpoint_Debug.setText(QtGui.QApplication.translate("MainWindow", "Set &Breakpoint", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Set_Breakpoint_Debug.setToolTip(QtGui.QApplication.translate("MainWindow", "Set breakpoint on a given line", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Debugger_Toolbar_View.setText(QtGui.QApplication.translate("MainWindow", "Debugger Toolbar", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Debugger_Toolbar_View.setToolTip(QtGui.QApplication.translate("MainWindow", "Show / hide debugger toolbar", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Print_Stacktrace_Debug.setText(QtGui.QApplication.translate("MainWindow", "Print Stacktrace", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Print_Stacktrace_Debug.setToolTip(QtGui.QApplication.translate("MainWindow", "Print a stacktrace with the current frame at the bottom", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Step_Debug.setText(QtGui.QApplication.translate("MainWindow", "&Step", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Step_Debug.setToolTip(QtGui.QApplication.translate("MainWindow", "Execute the current line and stop at the first possible occasion", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Next_Debug.setText(QtGui.QApplication.translate("MainWindow", "&Next", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Next_Debug.setToolTip(QtGui.QApplication.translate("MainWindow", "Continue execution until the next line in the current function is reached or it returns.", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Until_Debug.setText(QtGui.QApplication.translate("MainWindow", "&Until", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Until_Debug.setToolTip(QtGui.QApplication.translate("MainWindow", "Continue execution until the line with the line number greater than the current one is reached or when returning from current frame", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Return_Debug.setText(QtGui.QApplication.translate("MainWindow", "&Return", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Return_Debug.setToolTip(QtGui.QApplication.translate("MainWindow", "Continue execution until the current function returns", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Continue_Debug.setText(QtGui.QApplication.translate("MainWindow", "&Continue", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Continue_Debug.setToolTip(QtGui.QApplication.translate("MainWindow", "Continue execution, only stop when a breakpoint is encountered.", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Jump_Debug.setText(QtGui.QApplication.translate("MainWindow", "&Jump", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Jump_Debug.setToolTip(QtGui.QApplication.translate("MainWindow", "Set the next line that will be executed. Only available in the bottom-most frame.", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Args_To_Current_Function_Debug.setText(QtGui.QApplication.translate("MainWindow", "Print &Args To Current Function", None, QtGui.QApplication.UnicodeUTF8))
